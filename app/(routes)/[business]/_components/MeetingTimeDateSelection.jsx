...
function MeetingTimeDateSelection({eventInfo,businessInfo}) {
    ...
    const plunk = new Plunk("sk_80d401d0175da0e2fd4f699ca6710c431fac379febfa860c");
    useEffect(()=>{
  ...
  return (
    ...
    >
       ...
       width={150}
       height={150}/>
       <div className='grid grid-cols-1 md:grid-cols-3 mt-5 sm:flex flex-col'>
            {/* Meeting Info  */}
      ...
      {step==1? <Button className="mt-10 float-right" variant="destructive"
        disabled={!selectedTime||!date}
        onClick={()=>setStep(step+1)}
       >Next
       </Button>:
       <Button disabled={!userEmail||!userName} variant="destructive"
