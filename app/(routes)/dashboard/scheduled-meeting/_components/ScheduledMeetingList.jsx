...
import { Briefcase, CalendarCheck, Clock, Icon, Mail, Timer } from 'lucide-react'
        ...
        {meetingList&&meetingList.map((meeting,index)=>(
            ...
            <AccordionItem value="item-1">
                ...
                <AccordionContent>
                    ...
                    <h2 className='flex gap-2 font-bold'><Mail/>Sender Email:  {meeting?.userEmail} </h2>
                    <h2 className='flex gap-2 font-bold'><Briefcase/>Sender Buiness Name: {meeting?.businessName} </h2>
                    <h2 className='flex gap-2 font-bold'>Sender Name: {meeting?.userName} </h2>
